				...
				<div class="container">
					<div class="row">
						<div class="col-md-4 col-sm-8 col-xs-12">
							<div class="footer-box">
								...
								<div class="about-footer">
									...
									<p class="desc silver">Our products are freshly harvested, washed ready for box and finally <span class="color">[...]</span></p>
								</div>
							</div>
						</div>
						<div class="col-md-2 col-sm-4 col-xs-12">
							<div class="footer-box">
								...
								<ul class="list-none menu-footer">
									...
									<li><a href="#" class="silver">Health Tips</a></li>
									<li><a href="#" class="silver">Our Vendor</a></li>
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="footer-box">
								<h2 class="title24 white">Social Media - Share</h2>
						...
						<div class="col-md-3 col-sm-6 col-xs-12">
							<div class="footer-box">
								...
								<div class="contact-footer">
									<p class="desc silver"><span class="color"><i class="fa fa-home" aria-hidden="true"></i></span>Block - 09, Government Engineering college, Sec - 28, G'nagar, Gujarat - 382028</p>
									<p class="desc silver"><span class="color"><i class="fa fa-mobile" aria-hidden="true"></i></span>7567775854</p>
									<p class="desc silver"><span class="color"><i class="fa fa-envelope" aria-hidden="true"></i></span><a href="#" class="silver">shashi.info.iiitv@gmail.com</a></p>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-sm-6 col-xs-12">
							<p class="copyright silver text-left">Copyright © 2017 IIITV - All Rights Reserved.</p>
						</div>
						<div class="col-md-6 col-sm-6 col-xs-12">

					...
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-12">
							<ul class="info-account list-inline-block pull-right">
								...
								<li><a href="#" data-toggle="modal" data-target="#myModal"><span class="color"><i class="fa fa-key"></i></span>Login</a></li>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-5 col-sm-5 col-xs-12">
							<form class="search-form pull-left" action="search.php">
						...
						<ul>
							...
							<li class="menu-item-has-children">
								...
								<ul class="sub-menu">
									...
									<!-- <li><a href="detail-fullwidth.html">Product Detail</a></li> -->

						...
						<aside class="sidebar-left sidebar-shop">
							...
							<div class="widget widget-category">
								...
								<ul class="list-none wg-list-cat">
									...
									<li><a href="#">Fresh Meal</a><span class="color">9</span></li>
									<li><a href="#">Fruits Fresh</a><span class="color">12</span></li>
									<li><a href="#">Juice</a><span class="color">7</span></li>
									<li><a href="#">Vegetables</a><span class="color">5</span></li>
								</ul>
							</div>
							<!-- ENd Widget -->
									...
									<div class="wrap-item group-navi" data-pagination="false" data-navigation="true" data-itemscustom="[[0,1],[560,2],[768,1]]">
										<div class="item">
											...
											<div class="item-wg-product table">
												<div class="product-thumb">
													<a href="detail.html" class="product-thumb-link zoom-thumb">
														<img src="images/product/fruit_29.jpg" alt="">
													</a>
													<a href="quick-view.html" class="quickview-link fancybox fancybox.iframe"><i class="fa fa-search" aria-hidden="true"></i></a>
												</div>
												<div class="product-info">
										...
										<div class="item">
											...
											<div class="item-wg-product table">
												<div class="product-thumb">
													<a href="detail.html" class="product-thumb-link zoom-thumb">
														<img src="images/product/fruit_21.jpg" alt="">
													</a>
													<a href="quick-view.html" class="quickview-link fancybox fancybox.iframe"><i class="fa fa-search" aria-hidden="true"></i></a>
												</div>
												<div class="product-info">
											...
											<div class="item-wg-product table">
												<div class="product-thumb">
													<a href="detail.html" class="product-thumb-link zoom-thumb">
														<img src="images/product/fruit_25.jpg" alt="">
													</a>
													<a href="quick-view.html" class="quickview-link fancybox fancybox.iframe"><i class="fa fa-search" aria-hidden="true"></i></a>
												</div>
												<div class="product-info">
											...
											<div class="item-wg-product table">
												<div class="product-thumb">
													<a href="detail.html" class="product-thumb-link zoom-thumb">
														<img src="images/product/fruit_28.jpg" alt="">
													</a>
													<a href="quick-view.html" class="quickview-link fancybox fancybox.iframe"><i class="fa fa-search" aria-hidden="true"></i></a>
												</div>
												<div class="product-info">
					...
					<div class="col-md-9 col-sm-8 col-xs-12">
						<div class="main-content-shop">
							<div class="shop-pagibar clearfix">
								<p class="desc silver pull-left">Showing 1–9 of 18 results</p>
								<ul class="wrap-sort-view list-inline-block pull-right">
									...
									<li>
										<div class="view-bar">
											<a class="grid-view" href="grid.php"></a>
								...
								<div class="item-product item-product-list">
									<div class="row">
										<div class="col-md-4 col-sm-5 col-xs-5">
											<div class="product-thumb">
												<a href="detail.html" class="product-thumb-link zoomout-thumb">
													<img src="images/product/fruit_26.jpg" alt="">

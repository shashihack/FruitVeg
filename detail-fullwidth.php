							...
							<div class="row">
								<div class="col-md-6 col-sm-5 col-xs-12">
									<div class="detail-gallery">
										<div class="mid">
											<img src="images/product/fruit_24.jpg" alt=""/>
										</div>
										<div class="gallery-control">
											<div class="carousel">
												<ul class="list-none">
													<li><a href="#" class="active"><img src="images/product/fruit_24.jpg" alt=""/></a></li>
													<li><a href="#"><img src="images/product/fruit_25.jpg" alt=""/></a></li>
													<li><a href="#"><img src="images/product/fruit_26.jpg" alt=""/></a></li>
													<li><a href="#"><img src="images/product/fruit_27.jpg" alt=""/></a></li>
													<li><a href="#"><img src="images/product/fruit_28.jpg" alt=""/></a></li>
													<li><a href="#"><img src="images/product/fruit_29.jpg" alt=""/></a></li>
													<li><a href="#"><img src="images/product/fruit_23.jpg" alt=""/></a></li>
												</ul>
											</div>
											<a href="#" class="prev"></a>
											<a href="#" class="next"></a>
								...
								<div class="col-md-6 col-sm-7 col-xs-12">
									<div class="detail-info">
										<h2 class="title30 font-bold">Fresh Meal Kit</h2>
						...
						<div class="detail-tabs">
							<div class="title-tab-detail">
								<ul class="title-tab1 list-inline-block">
									...
									<li class=""><a href="#tab2" class="title14" data-toggle="tab" aria-expanded="false">Reviews(5)</a></li>
								</ul>
							</div>
...
<!-- Mirrored from demo.7uptheme.com/html/fruitshop/detail-fullwidth.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Sep 2017 02:35:02 GMT -->
</html>